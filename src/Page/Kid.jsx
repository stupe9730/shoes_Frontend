...
const Kid = () => {
  ...
  useEffect(() => {
    getProducts({ selecter: "Kid", page: currentPage, limit: 6 });
  }, [currentPage]);
    ...
    <>
      <div className="lg:px-24 px-8 dark:bg-black overflow-hidden ">
        <div className="py-3 dark:text-white">
          ...
          / <Link className="hover:text-blue-700 font-bold">Kid</Link>
        </div>
        <motion.div
        ...
        >
          <h1 className="text-4xl font-bold text-white ps-6">Kid</h1>
        </motion.div>
      </div>
